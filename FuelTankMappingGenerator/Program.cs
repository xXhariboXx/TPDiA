...
namespace FuelTankMappingGenerator
{
    public class Program
    {
        ...
        {
            MappingCreator mappingCreator = new MappingCreator(@"E:\OneDrive\Studia\TPDiA\Dane paliwowe wysokość dekalibracja\Dane paliwowe wysokość dekalibracja\dane\zniekształcone\Zestaw 1\tankMeasures.log",
               @"E:\OneDrive\Studia\TPDiA\Dane paliwowe wysokość dekalibracja\Dane paliwowe wysokość dekalibracja\dane\zniekształcone\Zestaw 1\nozzleMeasures.log",
               @"E:\OneDrive\Studia\TPDiA\Dane paliwowe wysokość dekalibracja\Dane paliwowe wysokość dekalibracja\dane\zniekształcone\Zestaw 1\refuel.log",
            ...
            mappingCreator.GenerateTankMeasures();
